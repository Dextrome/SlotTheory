...
public partial class HowToPlay : Node
{
    ...
    public static void BuildBasicsSection(VBoxContainer vbox, bool includeReferenceSections = true)
    {
        ...
        var premiumCard = AddSurgeCard(vbox, "PREMIUM CARDS", new Color(1.00f, 0.82f, 0.22f));
        AddSurgeRuleRow(premiumCard, "RARE", "Occasionally one draft card is silver -- a Rare Premium Card. These are run-level upgrades that apply immediately or persist for the full run.", new Color(0.80f, 0.88f, 0.98f, 0.92f));
        AddSurgeRuleRow(premiumCard, "SUPER RARE", "Gold-bordered cards are Super Rare. Stronger effects. A second shimmer sweep confirms the rarity.", new Color(1.00f, 0.82f, 0.22f, 0.92f));
        AddSurgeRuleRow(premiumCard, "REPLACES A SLOT", "The premium card takes the place of one of your normal draft options -- you still choose from the same number of cards.", new Color(0.75f, 0.85f, 1.00f, 0.85f));
        AddSurgeRuleRow(premiumCard, "EXPANDED CHASSIS", "The only card requiring a target: tap a tower after picking it to give that tower +1 mod slot (up to 5).", new Color(0.75f, 0.85f, 1.00f, 0.85f));
    }
