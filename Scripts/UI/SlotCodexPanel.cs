...
public partial class SlotCodexPanel : Node
{
    ...
    private static void PopulateUpgradeCards(GridContainer grid)
    {
    ...
    private static Control BuildUpgradeCard(Core.PremiumCardDef def)
    {
        ...
        {
            BgColor           = isSuperRare
                ? new Color(0.08f, 0.07f, 0.03f, 0.97f)
                : new Color(0.05f, 0.07f, 0.13f, 0.97f),
            BorderColor       = new Color(accent.R, accent.G, accent.B, 0.65f),
            BorderWidthLeft   = 2, BorderWidthRight  = 2,
            BorderWidthTop    = 2, BorderWidthBottom = 2,
            CornerRadiusTopLeft    = 10, CornerRadiusTopRight    = 10,
            CornerRadiusBottomLeft = 10, CornerRadiusBottomRight = 10,
            ShadowColor  = new Color(accent.R, accent.G, accent.B, isSuperRare ? 0.50f : 0.32f),
            ShadowSize   = isSuperRare ? 9 : 6,
        ...
        var glyphBox = new PanelContainer { CustomMinimumSize = new Vector2(46f, 46f) };
        var glyphStyle = new StyleBoxFlat
        {
            BgColor     = new Color(accent.R * 0.18f, accent.G * 0.18f, accent.B * 0.18f, 0.80f),
            BorderColor = new Color(accent.R, accent.G, accent.B, 0.40f),
            BorderWidthLeft = 1, BorderWidthRight = 1, BorderWidthTop = 1, BorderWidthBottom = 1,
            CornerRadiusTopLeft = 6, CornerRadiusTopRight = 6,
            CornerRadiusBottomLeft = 6, CornerRadiusBottomRight = 6,
        };
        glyphBox.AddThemeStyleboxOverride("panel", glyphStyle);
        top.AddChild(glyphBox);
        ...
        var rarityLbl = new Label { Text = isSuperRare ? "SUPER RARE" : "RARE" };
        rarityLbl.AddThemeFontSizeOverride("font_size", 12);
        rarityLbl.AddThemeColorOverride("font_color", accent);
        titleCol.AddChild(rarityLbl);
        ...
        descLbl.AddThemeColorOverride("font_color", new Color(0.82f, 0.86f, 0.96f));
        body.AddChild(descLbl);

        var chanceLbl = new Label { Text = "Appears randomly in drafts" };
        chanceLbl.AddThemeFontSizeOverride("font_size", 12);
