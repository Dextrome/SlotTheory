...
public partial class GridBackground : Node2D
{
    public override void _Draw()
    {
        ...
        DrawRect(new Rect2(0, 0, 1280, 720), new Color(0.04f, 0.00f, 0.10f));
        ...
        for (int r = 0; r <= MapGenerator.ROWS; r++)
        {
            ...
            DrawLine(new Vector2(0f, y), new Vector2(1280f, y), glow, 6f);
            DrawLine(new Vector2(0f, y), new Vector2(1280f, y), line, 1.5f);
        }

        // Horizon line — bright violet bar at top of play area
        DrawLine(new Vector2(0f, top), new Vector2(1280f, top),
