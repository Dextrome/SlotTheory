...
public static class VolatileDraftRegistry
{
    private static readonly VolatileDraftDef[] Definitions =
    {
        new(
            ...
            Name: "DEADEYE OATH",
            UpsideText: "+2 base damage to all towers",
            TradeoffText: "-12% range to all towers",
        ...
        new(
            ...
            Name: "STORM LATTICE",
            UpsideText: "+22% chain range to all towers",
            TradeoffText: "-1 base damage to all towers",
            IdentityTag: "CHAIN",
            FlatDamageDelta: -1,
            ChainRangeBonus: 22f),
        new(
            ...
            Name: "CRYO LOCK",
            UpsideText: "Slow duration +35%",
            TradeoffText: "Attack interval +10% (slower)",
        ...
        new(
            ...
            Name: "SIEGE PROTOCOL",
            UpsideText: "+3 base damage to all towers",
            TradeoffText: "Attack interval +12% (slower)",
            IdentityTag: "DETONATION",
            FlatDamageDelta: 3,
        ...
        new(
            ...
            Name: "PHASE NET",
            UpsideText: "+18% chain range to all towers",
            TradeoffText: "-8% range to all towers",
            IdentityTag: "CHAIN",
            ChainRangeBonus: 18f,
            RangeBonus: -20f),
    };
